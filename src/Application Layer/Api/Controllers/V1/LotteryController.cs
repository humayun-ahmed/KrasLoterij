...
namespace NederlandseLoterij.KrasLoterij.Api.Controllers.V1
{
    ...
    public class LotteryController : ControllerBase
    {
        ...
        private readonly FluentValidation.IValidator<ScratchCommand> m_validator;

        public LotteryController(ILotteryQueryService lotteryQueryService, ILotteryService lotteryService, FluentValidation.IValidator<ScratchCommand> validator)
        {
        ...
        public async Task<IActionResult> Put([FromBody] ScratchCommand lotteryCommand)
        {
            ...
            {
                return this.BadRequest(new List<ValidationFailure>{ new() {ErrorMessage = ex.Message} });
            }
        }
    }
}